...
date: 2026-04-30 21:54:46 +00:00
tags:
  - goosewobbler
  - GitHub Actions
draft: false
...
Version updated for **https://github.com/goosewobbler/releasekit** to version **v0.19.0**.
...
ReleaseKit is a lightweight tool designed to automate versioning, changelog generation, and package publishing for JavaScript and Rust projects, using conventional commit standards. It simplifies CI/CD workflows by offering composable tools that handle semantic versioning, AI-enhanced release notes, and publishing to registries like npm and crates.io, while supporting monorepos and configurable release strategies. Key capabilities include PR-based release previews, flexible templating, and JSON output for seamless integration into automated pipelines.
...
**Full Changelog**: https://github.com/goosewobbler/releasekit/commits/v0.19.0
