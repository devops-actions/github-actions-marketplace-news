...
date: 2026-04-17 06:33:41 +00:00
tags:
  - devcontainers
  - GitHub Actions
draft: false
...
version: v0.3.1900000448
dependentsNumber: "7,350"
actionType: Node
nodeVersion: 24
---
...
The **Dev Container Build and Run GitHub Action** simplifies the use of Dev Containers in GitHub workflows by automating tasks such as pre-building Dev Container images and running commands for CI, testing, and other development activities. It supports Dev Container Features, embeds metadata for streamlined image usage, and leverages the `@devcontainers/cli` for enhanced compatibility and functionality. This action addresses the need for consistent, reusable development environments and improves workflow efficiency by integrating containerized development into CI pipelines.
...
**Full Changelog**: https://github.com/devcontainers/ci/compare/v0.2.1900000266...v0.3.1900000448
