...
date: 2026-01-16 21:20:04 +00:00
tags:
  - AminFazlMondo
  - GitHub Actions
draft: false
...
The **Check Deployed Environment** GitHub Action verifies whether a specific commit is currently deployed to a specified environment in GitHub. It automates the process of checking active deployments, helping streamline workflows by determining deployment status and avoiding redundant deployments. Key capabilities include identifying active deployments and providing actionable outputs for conditional workflow steps.

## Release notes


## [1.5.70](https://github.com/AminFazlMondo/check-deployed-environment/compare/v1.5.69...v1.5.70) (2026-01-16)
