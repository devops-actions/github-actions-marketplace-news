...
date: 2026-05-14 14:36:43 +00:00
tags:
  - SAP
  - GitHub Actions
draft: false
...
Version updated for **https://github.com/SAP/pull-request-semver-bumper** to version **v1.0.2**.
...
The **Pull Request Semver Bumper** GitHub Action automates semantic versioning by updating the version directly within pull requests before they are merged. This ensures a clean and pre-versioned `main` branch, avoiding post-merge "release commits" that can clutter history and trigger unnecessary CI runs. It supports multiple languages (Maven, NPM, Python, and generic version files) and adheres to the **Conventional Commits** standard for streamlined version management and changelog generation.
