---
title: mcp-audit
date: 2026-05-16 21:28:04 +00:00
tags:
  - adudley78
  - GitHub Actions
draft: false
...
Version updated for **https://github.com/adudley78/mcp-audit** to version **v0.9.1**.
...
`mcp-audit` is a privacy-focused security scanning GitHub Action designed to audit and secure MCP (Model Context Protocol) server configurations. It automates the detection of vulnerabilities such as tool poisoning, credential exposure, transport security issues, supply chain risks, and multi-server attack paths, ensuring safer AI coding environments. With features like automated configuration discovery, live server analysis, interactive attack path visualization, and governance policy support, it aids developers in identifying and mitigating security risks across MCP setups.
...
```yaml
- uses: adudley78/mcp-audit@v0.9.1
  with:
