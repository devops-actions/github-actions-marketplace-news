...
date: 2026-02-20 13:22:37 +00:00
tags:
  - GhrammR
  - GitHub Actions
draft: false
...
The Janitor is a GitHub Action designed to automate the detection and removal of dead code at the symbol level across Python, Rust, JavaScript/TypeScript, and C++ codebases. It identifies unused functions, classes, and files, simulates their removal to ensure safety, and cleans up the codebase without corruption. By streamlining code maintenance, it reduces technical debt, improves code health, and offers tools like a Code Health Badge and duplicate logic detection for enhanced project monitoring and management.
