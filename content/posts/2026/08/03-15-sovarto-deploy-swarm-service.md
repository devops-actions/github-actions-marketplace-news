...
date: 2026-08-03 15:02:45 +00:00
tags:
  - sovarto
  - GitHub Actions
draft: false
...
nodeVersion: 20
actionSummary: |
  This GitHub Action automates the deployment of a Docker Swarm service. It ensures that all necessary dependencies are installed and bundled before committing the `dist` folder to version control, thereby preparing it for deployment to a Docker Swarm cluster.
---
