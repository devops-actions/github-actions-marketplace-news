...
date: 2026-08-10 05:52:12 +00:00
tags:
  - sovarto
  - GitHub Actions
draft: false
...
nodeVersion: 20
actionSummary: |
  This GitHub Action automates the deployment of a Docker Swarm service by bundling dependencies and committing the `dist` folder. It ensures that the necessary files are ready for deployment before pushing changes to the repository, facilitating a smoother workflow during development.
---
