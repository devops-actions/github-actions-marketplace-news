...
date: 2026-08-02 06:21:04 +00:00
tags:
  - postman-cs
  - GitHub Actions
draft: false
...
nodeVersion: 24
actionSummary: |
  This GitHub Action exports Postman collections and environments into a repository, wires CI, mock servers, and monitors around them. It automates the onboarding of Postman projects to an organization's repository by synchronizing assets and configuring CI workflows.
---
...
**Full Changelog**: https://github.com/postman-cs/postman-repo-sync-action/compare/v2.1.15...v2.8.7
