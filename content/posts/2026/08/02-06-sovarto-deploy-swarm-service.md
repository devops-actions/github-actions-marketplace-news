...
date: 2026-08-02 06:12:53 +00:00
tags:
  - sovarto
  - GitHub Actions
draft: false
...
nodeVersion: 20
actionSummary: |
  This GitHub Action automates the deployment of a Swarm service by running `npm ci` and `npm run bundle`, then commits the resulting `dist` folder to the repository. This ensures that the service is correctly packaged and ready for deployment when pushed to a Git repository.
---
