...
date: 2026-08-28 17:45:48 +00:00
tags:
  - sovarto
  - GitHub Actions
draft: false
...
nodeVersion: 20
actionSummary: |
  This GitHub Action automates the build process for a Docker Swarm service by running `npm ci` and `npm run bundle`, then commits the resulting distribution files to the repository. It helps streamline the development workflow by ensuring that the necessary dependencies are installed and the service is ready for deployment with just a push to the repository.
---
