---
title: MIU PR Review
date: 2026-08-24 05:54:22 +00:00
tags:
  - vanducng
  - GitHub Actions
draft: false
...
```sh
curl -fsSL https://cr.miu.sh/install.sh | sh -s -- v0.89.9
brew install vanducng/tap/miucr
go install github.com/vanducng/miu-cr/cmd/miucr@v0.89.9
```
