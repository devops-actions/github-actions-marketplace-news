...
date: 2026-06-27 06:27:27 +00:00
tags:
  - stjude-rust-labs
  - GitHub Actions
draft: false
...
Version updated for **https://github.com/stjude-rust-labs/sprocket-action** to version **v0.27.0**.
...
Bumps `sprocket` to [v0.27.0](https://github.com/stjude-rust-labs/sprocket/releases/tag/v0.27.0).
