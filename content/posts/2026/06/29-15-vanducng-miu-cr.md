---
title: MIU PR Review
date: 2026-06-29 15:08:41 +00:00
tags:
  - vanducng
  - GitHub Actions
draft: false
...
Version updated for **https://github.com/vanducng/miu-cr** to version **v0.72.0**.
...
```sh
curl -fsSL https://cr.miu.sh/install.sh | sh -s -- v0.72.0
brew install vanducng/tap/miucr
go install github.com/vanducng/miu-cr/cmd/miucr@v0.72.0
```
