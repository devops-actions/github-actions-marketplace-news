...
date: 2026-03-03 05:50:24 +00:00
tags:
  - subzone
  - GitHub Actions
draft: false
...
Version updated for **https://github.com/subzone/ssdlc-action** to version **v1.2.0**.
...
The AI SSDLC Security Suite GitHub Action automates secure software development lifecycle (SDLC) scans using AI-powered tools, integrating capabilities such as SAST, secret detection, SCA, IaC security, container scanning, AI triage, and STRIDE threat modeling. It simplifies the process of identifying and addressing security vulnerabilities across multiple layers without requiring additional tooling or complex configurations. This action enhances security workflows by streamlining threat detection, remediation suggestions, and reporting directly within GitHub.
...
**Full Changelog**: https://github.com/subzone/ssdlc-action/compare/v1.0.2...v1.2.0
