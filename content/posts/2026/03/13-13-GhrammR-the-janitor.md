...
date: 2026-03-13 13:33:43 +00:00
tags:
  - GhrammR
  - GitHub Actions
draft: false
...
The Janitor is a GitHub Action that acts as a structural firewall for AI-generated code, ensuring code quality and security by detecting and automatically removing dead code, zombie dependencies, and structural issues before pull requests are merged. It addresses the challenges of AI-assisted code, such as increased vulnerabilities and undetected antipatterns, by running locally with zero-copy execution, simulating code removal, and enforcing cryptographic integrity. This tool automates static analysis, dependency validation, and cleanup to maintain codebase integrity and prevent problematic code from reaching production.
