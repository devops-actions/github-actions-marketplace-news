...
date: 2026-03-09 13:36:30 +00:00
tags:
  - GhrammR
  - GitHub Actions
draft: false
...
The Janitor is a structural firewall for AI-generated and human-written code that automates the detection and removal of dead code, zombie dependencies, and structural vulnerabilities before pull requests are merged. It enhances code quality and security by performing lightning-fast, memory-efficient static analysis directly in your CI/CD pipeline, preventing issues introduced by AI-assisted tools. Key capabilities include live PR enforcement, cryptographic integrity tracking, and support for multiple programming languages.

## Release notes

# The Janitor: Structural Firewall for AI-Generated Code
**v6.11.2 — Rust-Native. Zero-Copy. Enforcement at the Gate.**
