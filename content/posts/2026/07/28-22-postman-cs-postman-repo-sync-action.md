...
date: 2026-07-28 22:46:38 +00:00
tags:
  - postman-cs
  - GitHub Actions
draft: false
...
nodeVersion: 24
actionSummary: |
  The Postman Onboarding Repo Sync action automates the process of exporting and syncing Postman collections, environments, CI workflows, mock servers, and monitors into a repository. It solves problems related to managing API onboarding and integration by providing a streamlined approach to integrating Postman assets with version control systems like GitHub. The action supports various configurations and inputs for customization, including handling different regions, authentication tokens, and environment settings.
---


Version updated for **https://github.com/postman-cs/postman-repo-sync-action** to version **v2.6.5**.
...
**Full Changelog**: https://github.com/postman-cs/postman-repo-sync-action/compare/v2.1.15...v2.6.5
