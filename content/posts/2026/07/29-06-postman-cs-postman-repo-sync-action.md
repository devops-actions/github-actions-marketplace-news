...
date: 2026-07-29 06:45:01 +00:00
tags:
  - postman-cs
  - GitHub Actions
draft: false
...
nodeVersion: 24
actionSummary: |
  This GitHub Action synchronizes Postman collections and environments into a repository, automates CI workflows around them, and manages mock servers and monitors. It solves the problem of manually exporting and managing these assets in a repository, providing automated solutions for continuous integration and testing. The key capabilities include exporting all required assets, setting up CI workflows, and managing mock servers and monitors automatically.
---


Version updated for **https://github.com/postman-cs/postman-repo-sync-action** to version **v2.6.8**.
...
**Full Changelog**: https://github.com/postman-cs/postman-repo-sync-action/compare/v2.1.15...v2.6.8
