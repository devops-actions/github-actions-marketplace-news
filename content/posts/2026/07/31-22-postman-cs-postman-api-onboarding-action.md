...
date: 2026-07-31 22:34:37 +00:00
tags:
  - postman-cs
  - GitHub Actions
draft: false
...
actionSummary: |
  This GitHub Action automates the setup and onboarding of a new API repository by generating Postman collections, environments, mock servers, and monitors. It uploads an OpenAPI specification, creates a workspace, and sets up CI/CD pipelines to ensure automated smoke and contract testing. The action integrates with the Postman Onboarding suite for seamless integration with the Postman ecosystem, providing comprehensive test coverage for new APIs.
---


Version updated for **https://github.com/postman-cs/postman-api-onboarding-action** to version **v3.1.2**.
...
**Full Changelog**: https://github.com/postman-cs/postman-api-onboarding-action/compare/v2.1.8...v3.1.2
