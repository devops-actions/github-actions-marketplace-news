...
date: 2026-07-30 14:48:55 +00:00
tags:
  - postman-cs
  - GitHub Actions
draft: false
...
nodeVersion: 24
actionSummary: |
  This GitHub Action automates the process of exporting Postman collections and environments into a repository. It also sets up CI, mocks, and monitors based on these assets. The action solves the problem of manually managing these configurations by providing a comprehensive solution that handles various inputs and outputs.
---


Version updated for **https://github.com/postman-cs/postman-repo-sync-action** to version **v2.7.0**.
...
**Full Changelog**: https://github.com/postman-cs/postman-repo-sync-action/compare/v2.1.15...v2.7.0
