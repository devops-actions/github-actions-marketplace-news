---
title: JFrog Boost
date: 2026-07-28 22:58:42 +00:00
tags:
  - jfrog
  - GitHub Actions
draft: false
repo: https://github.com/jfrog/boost
marketplace: https://github.com/marketplace/actions/jfrog-boost
version: v0.9.21
dependentsNumber: "4"
actionType: Composite
actionSummary: |
  Boost is a tool that compresses noisy logs into structured context for coding agents and shell commands. It saves tokens by trimming only what's safe to drop, ensuring agent output stays sharp. The action automates the process of integrating Boost into CI/CD pipelines, enabling teams to efficiently manage their codebase while optimizing agent performance.
---


Version updated for **https://github.com/jfrog/boost** to version **v0.9.21**.
...
Go to the [GitHub Marketplace](https://github.com/marketplace/actions/jfrog-boost) to find the latest changes.
...
**Full Changelog**: https://github.com/jfrog/boost/compare/v0.7.23...v0.9.21
