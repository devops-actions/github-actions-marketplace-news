...
date: 2026-07-31 14:47:11 +00:00
tags:
  - Odin-Scan
  - GitHub Actions
draft: false
...
nodeVersion: 20
actionSummary: |
  The Odin Scan GitHub Action automates the security scanning of CosmWasm, Solana, and EVM smart contracts. It integrates with GitHub Code Scanning to provide real-time alerts on pull requests, inline annotations, and detailed reports. The action supports automatic platform detection and customizable severity thresholds for failing builds.
---
