---
title: MIU PR Review
date: 2026-07-03 22:05:49 +00:00
tags:
  - vanducng
  - GitHub Actions
draft: false
...
```sh
curl -fsSL https://cr.miu.sh/install.sh | sh -s -- v0.84.1
brew install vanducng/tap/miucr
go install github.com/vanducng/miu-cr/cmd/miucr@v0.84.1
```
