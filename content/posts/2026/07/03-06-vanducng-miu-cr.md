---
title: MIU PR Review
date: 2026-07-03 06:33:12 +00:00
tags:
  - vanducng
  - GitHub Actions
draft: false
...
```sh
curl -fsSL https://cr.miu.sh/install.sh | sh -s -- v0.82.4
brew install vanducng/tap/miucr
go install github.com/vanducng/miu-cr/cmd/miucr@v0.82.4
```
