...
date: 2026-07-27 23:09:37 +00:00
tags:
  - postman-cs
  - GitHub Actions
draft: false
...
nodeVersion: 24
actionSummary: |
  This action automates the synchronization of Postman collections and environments into a GitHub repository. It exports these assets to facilitate CI integration, mock server setup, and monitor configuration. The key capabilities include exporting collections, environments, and setting up CI and monitoring workflows. Users can specify inputs like project name, workspace ID, collection IDs, and environment settings to customize the synchronization process.
---


Version updated for **https://github.com/postman-cs/postman-repo-sync-action** to version **v2.6.2**.
...
**Full Changelog**: https://github.com/postman-cs/postman-repo-sync-action/compare/v2.1.15...v2.6.2
