...
date: 2026-07-27 23:08:30 +00:00
tags:
  - postman-cs
  - GitHub Actions
draft: false
...
nodeVersion: 24
actionSummary: |
  The Postman Onboarding: Smoke Flow action reshapes a generated Postman Smoke collection into an ordered smoke journey using one effective flow path. It automates the process of deriving or curating a manifest for the collection, handles OAuth2 and API key authentication, and is part of the larger Postman API Onboarding suite. The action requires a workspace ID, spec ID, Smoke collection ID, and optionally a flow path or an OpenAPI spec path to create or update the flow path in the Smoke collection.
---


Version updated for **https://github.com/postman-cs/postman-smoke-flow-action** to version **v3.1.1**.
...
**Full Changelog**: https://github.com/postman-cs/postman-smoke-flow-action/compare/v2.1.7...v3.1.1
