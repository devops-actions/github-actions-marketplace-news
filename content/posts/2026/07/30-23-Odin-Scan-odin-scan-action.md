...
date: 2026-07-30 23:49:44 +00:00
tags:
  - Odin-Scan
  - GitHub Actions
draft: false
...
nodeVersion: 20
actionSummary: |
  The Odin Scan GitHub Action is a tool that integrates AI-powered smart contract security analysis into your workflow. It supports multiple platforms (CosmWasm, Solana, and EVM), automatically detects the target platform, and provides detailed security insights through inline annotations and PR comments. Users can configure thresholds for severity levels and fail builds based on these configurations. The action also uploads SARIF files for native security alerts and a full JSON report as a workflow artifact.
---
