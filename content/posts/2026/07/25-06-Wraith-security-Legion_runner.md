---
title: Legion Runner
date: 2026-07-25 06:35:30 +00:00
tags:
  - Wraith-security
  - GitHub Actions
draft: false
repo: https://github.com/Wraith-security/Legion_runner
marketplace: https://github.com/marketplace/actions/legion-runner
version: v1.0.46
dependentsNumber: "8"
actionType: Node
nodeVersion: 24
actionSummary: |
  Legion Runner is an open-source action designed to secure CI/CD workflows by monitoring outbound connections from GitHub Actions jobs. It records every outgoing network request, names the process responsible for initiating them, and enforces a denylist of allowed destinations. The Action runs on Node.js without any external dependencies, ensuring that no sensitive information leaves the runner. It also includes an ephemeral self-hosted runner option for teams looking to own their entire CI/CD infrastructure.
---


Version updated for **https://github.com/Wraith-security/Legion_runner** to version **v1.0.46**.
...
Go to the [GitHub Marketplace](https://github.com/marketplace/actions/legion-runner) to find the latest changes.
