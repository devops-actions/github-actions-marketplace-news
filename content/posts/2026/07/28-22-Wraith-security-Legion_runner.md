---
title: Legion Runner
date: 2026-07-28 22:34:40 +00:00
tags:
  - Wraith-security
  - GitHub Actions
draft: false
...
nodeVersion: 24
actionSummary: |
  Legion Runner is an open-source action that helps protect CI/CD pipelines from supply chain attacks by monitoring and blocking outbound connections made by GitHub Actions jobs. It records every outbound connection, names the process responsible, and enforces a blocklist of allowed destinations, ensuring that only approved actions and resources are accessed during the build process.
---


Version updated for **https://github.com/Wraith-security/Legion_runner** to version **v1.0.51**.
