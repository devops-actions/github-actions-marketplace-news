...
date: 2026-07-30 17:32:24 +00:00
tags:
  - Odin-Scan
  - GitHub Actions
draft: false
...
nodeVersion: 20
actionSummary: |
  This GitHub Action automates smart contract security analysis using Odin Scan, a tool that detects vulnerabilities in CosmWasm, Solana, and EVM projects. It integrates seamlessly into CI/CD workflows to help developers catch issues before deploying their code to production. The action provides features like platform detection, PR comments, inline annotations, comment-triggered scans, configurable thresholds, artifact uploads, and SARIF file generation for native security alerts.
---
