---
title: Legion Runner
date: 2026-07-27 14:46:11 +00:00
tags:
  - Wraith-security
  - GitHub Actions
draft: false
...
nodeVersion: 24
actionSummary: |
  Legion Runner is an open-source action that monitors and blocks outbound connections from GitHub Actions jobs to prevent supply chain attacks. It records and logs every egress connection, names the process responsible, and enforces a default-deny allowlist. The action runs on pure Node built-ins with no dependencies, providing a self-contained, secure solution for hardening CI against attacks without leaving the runner or sending data to third-party services.
---


Version updated for **https://github.com/Wraith-security/Legion_runner** to version **v1.0.49**.
