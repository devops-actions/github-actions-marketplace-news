---
title: MIU PR Review
date: 2026-07-12 06:06:49 +00:00
tags:
  - vanducng
  - GitHub Actions
draft: false
...
```sh
curl -fsSL https://cr.miu.sh/install.sh | sh -s -- v0.85.3
brew install vanducng/tap/miucr
go install github.com/vanducng/miu-cr/cmd/miucr@v0.85.3
```
