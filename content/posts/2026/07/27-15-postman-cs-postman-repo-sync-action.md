...
date: 2026-07-27 15:00:09 +00:00
tags:
  - postman-cs
  - GitHub Actions
draft: false
...
nodeVersion: 24
actionSummary: |
  This GitHub Action automates the process of exporting Postman collections and environments into a repository. It also sets up CI, mock servers, and monitors around these assets, which helps in managing and testing APIs more efficiently. The action requires a Postman API key or a service token to authenticate with Postman and sync data with a specified repository. It supports various inputs such as project name, workspace ID, collection IDs, and environment URLs, allowing for customization of the sync process.
---


Version updated for **https://github.com/postman-cs/postman-repo-sync-action** to version **v2.5.0**.
...
**Full Changelog**: https://github.com/postman-cs/postman-repo-sync-action/compare/v2.1.15...v2.5.0
