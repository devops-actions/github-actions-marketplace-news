---
title: Legion Runner
date: 2026-07-26 06:22:49 +00:00
tags:
  - Wraith-security
  - GitHub Actions
draft: false
...
nodeVersion: 24
actionSummary: |
  Legion Runner is an open-source action that hardens GitHub Actions against supply chain attacks by monitoring outbound connections, blocking unauthorized destinations, and verifying file integrity at job start and end. It provides process attribution inline through socket-layer eBPF capture. The Action runs on pure Node with no dependencies, ensuring security without leaving the runner environment.
---


Version updated for **https://github.com/Wraith-security/Legion_runner** to version **v1.0.47**.
