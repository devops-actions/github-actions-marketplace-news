...
date: 2024-09-02 08:46:36 +00:00
tags:
  - afritzler
  - GitHub Actions
draft: false
...
Version updated for **afritzler/mkdocs-gh-pages-action** to version **v9.5.33**.
...
- Bump pascalgn/size-label-action from 0.5.2 to 0.5.4 @dependabot (#236)
- Bump mkdocs-material from 9.5.32 to 9.5.33 @dependabot (#235)
