...
date: 2024-05-01 19:30:04 +00:00
tags:
  - yykamei
  - GitHub Actions
draft: false
...
Version updated for **yykamei/block-merge-based-on-time** to version **v3.1.3**.
...
## What's Changed
### Features
* Update Holidays by @yykamei-app in https://github.com/yykamei/block-merge-based-on-time/pull/1572


**Full Changelog**: https://github.com/yykamei/block-merge-based-on-time/compare/v3.1.2...v3.1.3
