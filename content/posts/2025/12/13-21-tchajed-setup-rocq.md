---
title: Set up Rocq
date: 2025-12-13 21:11:57 +00:00
tags:
  - tchajed
  - GitHub Actions
draft: false
...
Version updated for **https://github.com/tchajed/setup-rocq** to version **v1.5.0**.
...
- **New feature:** customize the files used for the cache key (typically `*.opam`).
