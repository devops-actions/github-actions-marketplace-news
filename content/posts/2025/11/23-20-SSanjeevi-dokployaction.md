...
date: 2025-11-23 20:59:02 +00:00
tags:
  - SSanjeevi
  - GitHub Actions
draft: false
...
Version updated for **https://github.com/SSanjeevi/dokployaction** to version **v1.2.9**.
...
- **Main Action**: `SSanjeevi/dokployaction@v1.2.9`
- **Deploy**: `SSanjeevi/dokployaction/actions/deploy@v1.2.9`
- **Health Check**: `SSanjeevi/dokployaction/actions/health-check@v1.2.9`
- **Cleanup Containers**: `SSanjeevi/dokployaction/actions/cleanup-containers@v1.2.9`
- **Rollback**: `SSanjeevi/dokployaction/actions/rollback@v1.2.9`
- **Setup SSL**: `SSanjeevi/dokployaction/actions/setup-ssl@v1.2.9`
- **Configure Domain**: `SSanjeevi/dokployaction/actions/configure-domain@v1.2.9`
...
- name: Deploy to Dokploy
  uses: SSanjeevi/dokployaction@v1.2.9
  with:
    dokploy-url: 
    api-key: 
