...
date: 2025-11-21 21:17:03 +00:00
tags:
  - SSanjeevi
  - GitHub Actions
draft: false
...
- **Main Action**: `SSanjeevi/dokployaction@v1.2.0`
- **Deploy**: `SSanjeevi/dokployaction/actions/deploy@v1.2.0`
- **Health Check**: `SSanjeevi/dokployaction/actions/health-check@v1.2.0`
- **Cleanup Containers**: `SSanjeevi/dokployaction/actions/cleanup-containers@v1.2.0`
- **Rollback**: `SSanjeevi/dokployaction/actions/rollback@v1.2.0`
- **Setup SSL**: `SSanjeevi/dokployaction/actions/setup-ssl@v1.2.0`
- **Configure Domain**: `SSanjeevi/dokployaction/actions/configure-domain@v1.2.0`
