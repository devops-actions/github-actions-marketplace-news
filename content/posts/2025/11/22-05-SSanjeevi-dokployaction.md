...
date: 2025-11-22 05:13:05 +00:00
tags:
  - SSanjeevi
  - GitHub Actions
draft: false
...
Version updated for **https://github.com/SSanjeevi/dokployaction** to version **v1.2.3**.
...
- **Main Action**: `SSanjeevi/dokployaction@v1.2.3`
- **Deploy**: `SSanjeevi/dokployaction/actions/deploy@v1.2.3`
- **Health Check**: `SSanjeevi/dokployaction/actions/health-check@v1.2.3`
- **Cleanup Containers**: `SSanjeevi/dokployaction/actions/cleanup-containers@v1.2.3`
- **Rollback**: `SSanjeevi/dokployaction/actions/rollback@v1.2.3`
- **Setup SSL**: `SSanjeevi/dokployaction/actions/setup-ssl@v1.2.3`
- **Configure Domain**: `SSanjeevi/dokployaction/actions/configure-domain@v1.2.3`
...
- name: Deploy to Dokploy
  uses: SSanjeevi/dokployaction@v1.2.3
  with:
    dokploy-url: 
    api-key: 
