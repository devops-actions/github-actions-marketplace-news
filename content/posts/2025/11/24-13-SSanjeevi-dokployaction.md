...
date: 2025-11-24 13:07:44 +00:00
tags:
  - SSanjeevi
  - GitHub Actions
draft: false
...
Version updated for **https://github.com/SSanjeevi/dokployaction** to version **v1.2.10**.
...
## 🚀 Dokploy GitHub Actions - v1.2.10
...
- **Main Action**: `SSanjeevi/dokployaction@v1.2.10`
- **Deploy**: `SSanjeevi/dokployaction/actions/deploy@v1.2.10`
- **Health Check**: `SSanjeevi/dokployaction/actions/health-check@v1.2.10`
- **Cleanup Containers**: `SSanjeevi/dokployaction/actions/cleanup-containers@v1.2.10`
- **Rollback**: `SSanjeevi/dokployaction/actions/rollback@v1.2.10`
- **Setup SSL**: `SSanjeevi/dokployaction/actions/setup-ssl@v1.2.10`
- **Configure Domain**: `SSanjeevi/dokployaction/actions/configure-domain@v1.2.10`
...
- name: Deploy to Dokploy
  uses: SSanjeevi/dokployaction@v1.2.10
  with:
    dokploy-url: 
    api-key: 
