---
title: lw-scanner
date: 2023-10-04 18:48:07 +00:00
tags:
  - lacework
  - GitHub Actions
draft: false
repo: lacework/lw-scanner-action
marketplace: https://github.com/marketplace/actions/lw-scanner
version: v1.4.0
dependentsNumber: "40"
---


Version updated for **lacework/lw-scanner-action** to version **v1.4.0**.
- This publisher is shown as erified by GitHub.
- This action is used across all versions by **40** repositories.

Go to the [GitHub Marketplace](https://github.com/marketplace/actions/lw-scanner) to find the latest changes.
