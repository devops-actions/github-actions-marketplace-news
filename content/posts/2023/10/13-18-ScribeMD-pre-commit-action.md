...
date: 2023-10-13 18:51:50 +00:00
tags:
  - ScribeMD
  - GitHub Actions
draft: false
...
Version updated for **ScribeMD/pre-commit-action** to version **0.9.111**.
...
- Bump [actions/setup-python](https://github.com/actions/setup-python) from v4.7.0 to v4.7.1 (#390).

**Full Changelog**: https://github.com/ScribeMD/pre-commit-action/compare/0.9.110...0.9.111
