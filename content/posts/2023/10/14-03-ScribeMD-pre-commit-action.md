...
date: 2023-10-14 03:17:19 +00:00
tags:
  - ScribeMD
  - GitHub Actions
draft: false
...
Version updated for **ScribeMD/pre-commit-action** to version **0.9.112**.
...
- Bump [Commitizen](https://github.com/commitizen-tools/commitizen) from v3.9.1 to v3.10.0 (#393).

**Full Changelog**: https://github.com/ScribeMD/pre-commit-action/compare/0.9.111...0.9.112
