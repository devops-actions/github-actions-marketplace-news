...
date: 2023-09-05 11:16:59 +00:00
tags:
  - ScribeMD
  - GitHub Actions
draft: false
...
Version updated for **ScribeMD/pre-commit-action** to version **0.9.98**.
...
- Bump [actions/checkout](https://github.com/actions/checkout) from v3.5.3 to v4.0.0 (#360).

**Full Changelog**: https://github.com/ScribeMD/pre-commit-action/compare/0.9.97...0.9.98
